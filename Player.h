...
public:
	...
	void SetunplayableTurns(int numberInput); //A setter for the unplayableTurns
	int GetunplayableTurns();
	void SetJustRollDiceNum(int DiceNum);
	int GetJustRollDiceNum();
	...
	void Player::Restart(Grid* pGrid, int number=0);
};